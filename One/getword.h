...
eleven characters "/home/alone" to be placed in the buffer.  Similarly
if getword() reads "~ABCD", then "/home/aloneABCD" goes into the buffer
pointed to by w (and getword() returns 15).  But, if getword() reads
"AB~CD", then simply return the five-character string "AB~CD" (since '~'
was NOT the first character in the word).  Caution: don't hard-code your
